...
//
//     final wModel = wModelFromJson(jsonString);

import 'dart:convert';

WModel wModelFromJson(String str) => WModel.fromJson(json.decode(str));

String wModelToJson(WModel data) => json.encode(data.toJson());
